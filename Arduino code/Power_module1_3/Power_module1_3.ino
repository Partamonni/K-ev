...
void loop()
{
  ...
  if(!ds.reset())
    serialPrint("!T"); // Sensor bus failed
  else
  {
...
int calcSOC()
{
  ...
  stateOfCharge = (capacity - coulombCounter) / capacity;
  ...
  if(nominalUsage)
  {
    ...
    stateOfChargeHelper += stateOfCharge * 99;
    stateOfChargeHelper /= 100;
